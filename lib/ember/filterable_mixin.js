/*
    Taken from here: https://github.com/emberjs/ember.js/pull/1288,
    I don't think that this is the best implementation, but it works
    and fixes the problems that my simple filtering had.

    TODO: remove this when ember has builtin filtering or rewrite it
 */
...
Ember.FilterableMixin = Ember.Mixin.create(Ember.MutableEnumerable, {
  ...
  arrangedContent: Ember.computed('content', 'filterProperties.@each', 'filterValue', function(key, value) {
    var content = get(this, 'content'),
